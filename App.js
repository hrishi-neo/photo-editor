            ...
            <RNImageEditor
              ...
              onClosePressed={() => {
                ...
                if (undoArray.length > 0) {
                  this.canvas.addPath(undoArray[undoArray.length - 1]);
                  undoArray.pop();
                }
              }}
              undoComponent={
              ...
              onUndoPressed={id => {
                ...
                // this.canvas.addShape({ shapeType: 'Square' });
                // this.canvas.addShape({ shapeType: 'Square' });
                // this.canvas.addShape({ shapeType: 'Star' });
              ...
              onClearPressed={() => {
                ...
                //this.canvas.addPath(this.state.redoId)
              }}
